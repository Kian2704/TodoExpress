...
export default function NewListSettings({
  duration,
  listName,
  tasks,
  startingDate,
        ...
        <div className="row container bg-secondary">
          <div className="col col-12">
            <NewListDate
              ...
              show={true}
              showExtended={highlighted}
              highlighted={highlighted}
              handleChecked={handleSpecify}
            />
            <NewListRepeat
              show={highlighted}
              showExtended={true}
              setAutoReset={handleAutoReset}
              autoReset={autoReset}
              setRepeatAfter={handleRepeatAfter}
